...
// WriteFileStreamOptimized handles streaming file uploads with minimal memory usage
func (c *Coordinator) WriteFileStreamOptimized(stream protocol.Coordinator_WriteFileStreamServer) error {
	var path string
...
// ReadFileStreamOptimized handles streaming file downloads with minimal memory usage
func (c *Coordinator) ReadFileStreamOptimized(req *protocol.ReadFileStreamRequest, stream protocol.Coordinator_ReadFileStreamServer) error {
