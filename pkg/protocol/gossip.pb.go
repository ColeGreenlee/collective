...
func (PeerStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_gossip_proto_enumTypes[2].Descriptor()
}

func (PeerStatus) Type() protoreflect.EnumType {
	return &file_gossip_proto_enumTypes[2]
}
...
const file_gossip_proto_rawDesc = "" +
	"\n" +
	"\fgossip.proto\x12\x11collective.gossip\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8c\x04\n" +
	"\rGossipMessage\x121\n" +
...
var file_gossip_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
