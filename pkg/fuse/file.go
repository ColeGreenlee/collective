...
func (f *CollectiveFile) Getattr(ctx context.Context, fh fuse.FileHandle, out *fuse.AttrOut) syscall.Errno {
...
func (f *CollectiveFile) Open(ctx context.Context, flags uint32) (fh fuse.FileHandle, fuseFlags uint32, errno syscall.Errno) {
...
func (f *CollectiveFile) Read(ctx context.Context, fh fuse.FileHandle, dest []byte, off int64) (fuse.ReadResult, syscall.Errno) {
...
func (f *CollectiveFile) Write(ctx context.Context, fh fuse.FileHandle, data []byte, off int64) (uint32, syscall.Errno) {
...
func (f *CollectiveFile) Flush(ctx context.Context, fh fuse.FileHandle) syscall.Errno {
...
func (f *CollectiveFile) Release(ctx context.Context, fh fuse.FileHandle) syscall.Errno {
